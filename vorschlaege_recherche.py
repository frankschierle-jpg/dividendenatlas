...
# Aufgabe (suchen, Zahlen extrahieren, als JSON formatieren) ausreichend.
MODELL = "claude-haiku-4-5-20251001"
ANZAHL_VORSCHLAEGE = 3  # von 5 auf 3 reduziert - weniger Firmen = weniger noetige Suchen
MIN_RENDITE = 5.0
MAX_SUCHEN = 6  # harte Obergrenze fuer Websuchen pro Lauf (siehe web_search-Tool unten) -
# begrenzt die Kosten unabhaengig davon, wie gruendlich das Modell sonst suchen wuerde
...
def main():
    ...
    print(f"Frage {MODELL} nach {ANZAHL_VORSCHLAEGE} neuen Kandidaten (max. {MAX_SUCHEN} Suchen) ...")
