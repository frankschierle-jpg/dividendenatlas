...
// Schwarzes Warndreieck mit rosa Ausrufezeichen statt Text "Falle"
const TRAP_ICON = `<svg width="15" height="15" viewBox="0 0 24 24" style="vertical-align:middle;margin-left:4px;" title="Moegliche Dividenden-Falle">
  <path d="M12 2.5 L22.5 21 L1.5 21 Z" fill="#1A1A1E"/>
  <text x="12" y="18.5" text-anchor="middle" fill="#FF2E9A" font-size="12" font-weight="800" font-family="Arial,sans-serif">!</text>
</svg>`;
