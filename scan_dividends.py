...
def main():
    ...
    analysten_queue = set(analysten_warteschlange(all_tickers, history, ANALYSTEN_PRO_LAUF))
    ...
    build_report(depot_view, scanner_view, chance_hinweis, fx_rates, vorschlaege)
