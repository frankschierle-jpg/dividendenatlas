...
function showDetail(ticker) {{
  ...
  document.getElementById('detail-content').innerHTML = `
    ...
    <table>
      <tr><td>ISIN</td><td style="font-family:monospace;">${{r.isin || ('nicht verfuegbar' + fehltHinweis('isin'))}}
      ...
      <tr><td>Marktkapitalisierung</td><td>${{r.market_cap ? (r.market_cap/1e9).toFixed(1) + ' Mrd. $' : '–' + fehltHinweis('market_cap')}}
      ...
      <tr><td>KGV</td><td>${{fmt(r.pe_ratio)}}${{(r.pe_ratio === null || r.pe_ratio === undefined) ? fehltHinweis('pe_ratio') : ''}}
      ...
      <tr><td>Ausschuettungsquote${{r.payout_ratio_fcf_pct !== null && r.payout_ratio_fcf_pct !== undefined ? ' (Free Cashflow)' : ' (Gewinn)'}}</td><td>${{fmt(r.payout_ratio_fcf_pct !== null && r.payout_ratio_fcf_pct !== undefined ? r.payout_ratio_fcf_pct : r.payout_ratio_pct, '%')}}${{(r.payout_ratio_fcf_pct === null || r.payout_ratio_fcf_pct === undefined) && (r.payout_ratio_pct === null || r.payout_ratio_pct === undefined) ? fehltHinweis('payout_ratio_pct') : ''}}
      ...
      <tr><td>Nächste erwartete Auszahlung</td><td>${{r.next_payout || ('nicht verfuegbar' + fehltHinweis('next_payout'))}}
      ...
      <tr><td>Verschuldung (D/E)</td><td>${{(r.debt_to_equity !== null && r.debt_to_equity !== undefined) ? fmt(r.debt_to_equity) : '–' + fehltHinweis('debt_to_equity')}}
